...
% Browse through the kaggle_dataset for variety of License Plates
% Note: some plates are not properly visible thus detection is fatel for
% those images
im = imread('Number Plate Images/kaggle_dataset/Cars44.png');

% Browse through detected_plates data set for proper detection
%im = imread('Number Plate Images/detected_plates/image2.png');
